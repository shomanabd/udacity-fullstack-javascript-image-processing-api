...
describe('resizeImage function', function () {
    var testFile = 'santamonica.jpg';
    var width = 200;
    var height = 200;
    var outputPath;
    it('should return a string path', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, imageProcessor_1.default)(testFile, width, height)];
                case 1:
    ...
    it('should create the resized image in the output folder', function () {
