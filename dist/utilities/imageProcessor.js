...
var outputdir = 'thumb';
var resizeImage = function (inputPath, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    var filename, outputPath, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, sharp_1.default)(inputPath).resize(width, height).toFile(outputPath)];
            case 1:
                _a.sent();
                return [2 /*return*/, outputPath];
            case 2:
                err_1 = _a.sent();
                throw new Error("Error processing image: ".concat(err_1));
